...
{
  [[Rakam instance] logEvent:@"Start Game"];
...
- (void)moveToDirection:(M2Direction)direction
{
  ...
  if (_level != nextLevel) {
    RakamIdentify *identify = [[RakamIdentify identify] set:@"level" value: [NSNumber numberWithUnsignedInteger:_level]];
    [identify append:@"list" value:@"value"];
    [[Rakam instance] identify:identify];
    [[Rakam instance] logEvent:@"Level Up" withEventProperties:@{
